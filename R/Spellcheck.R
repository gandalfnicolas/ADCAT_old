...
#' @export
#' @examples
#' mapply(Spellcheck,raw = list_of_uncleaned_words, cleaned = list_of_Cleaned_words, MoreArgs = list(rawlist = list_of_uncleaned_words, dict_cleaned= list_of_dictionary_words))
